...
//    let board      = ScrabbleUtil.InfiniteHoleBoard.infiniteHoleBoard ()
    ...
    let dictAPI =
        ...
        Some (Dictionary.empty, Dictionary.insert, Dictionary.step, None) |> ignore
        None
        
    // Uncomment this line to call your client
    //let players    = [("LexiIngenium", LexiIngenium.Scrabble.startGame)]
    let (dictionary, time) =
        time (fun () -> ScrabbleUtil.Dictionary.mkDict words dictAPI)

    //let players = spawnMultiples "OxyphenButazone" dictionary Oxyphenbutazone.Scrabble.startGame 2

    let players = spawnMultiples "LexiIngenium" dictionary LexiIngenium.Scrabble.startGame 2
